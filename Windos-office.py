...
# --- CONEXIÓN A GOOGLE SHEETS (PLAN B: BASE64) ---
scope = [
...
def conectar_google_sheets():
    # Si guardas tu JSON completo codificado en base64 en los secrets bajo una sola variable llamada "json_b64"
    # O si prefieres decodificar directamente desde los campos:
    gcp_secrets = st.secrets["gcp_service_account"]
    
    # Aseguramos la reconstrucción limpia de la llave privada de forma segura
    raw_key = gcp_secrets["private_key"]
    if "\\n" in raw_key:
    ...
    # Creamos un archivo temporal utilizando codificación estricta utf-8 en bytes para evitar errores de criptografía
    json_path = "credentials_b64.json"
