...
def get_sheets_client():
    # Cargar los secrets como diccionario directamente[cite: 6]
    creds_dict = dict(st.secrets["gcp_service_account"])
    
    # Asegurar saltos de línea correctos en la llave privada[cite: 6]
    if "private_key" in creds_dict:
        creds_dict["private_key"] = creds_dict["private_key"].replace("\\n", "\n")
        
    # Método directo de gspread para conectar usando el diccionario de la cuenta de servicio
    client = gspread.service_account_from_dict(creds_dict)
    return client

# URL de tu hoja de Google Sheets[cite: 6]
SPREADSHEET_URL = "https://docs.google.com/spreadsheets/d/1TxukcYhPDoCKrbqhzbUBKFLauvTRBlwrXq5IH2m0Zs/edit"

# Lista de hojas (pestañas)[cite: 6]
WORKSHEETS = [
    ...
    with st.form("registro_form"):
        ...
        if submit:
            try:
                ...
                # Se abre el documento mediante su URL completa[cite: 6]
