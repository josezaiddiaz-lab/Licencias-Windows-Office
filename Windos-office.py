...
def conectar_google_sheets():
    ...
    # Arreglamos la llave privada de forma radical y directa
    raw_key = gcp_secrets["private_key"]
    
    # Si viene con barras invertidas literales, las convertimos a saltos de línea reales
    if "\\n" in raw_key:
        raw_key = raw_key.replace("\\n", "\n")
        
    # Aseguramos que la estructura PEM comience y termine exactamente como lo exige OpenSSL
