...
def conectar_google_sheets():
    ...
    # Escribimos un archivo JSON físico fijo para evitar por completo el error de criptografía
    json_path = "credentials.json"
    with open(json_path, "w") as f:
        json.dump(creds_dict, f)

    # Cargamos estrictamente desde archivo físico (Cero uso de from_service_account_info)
