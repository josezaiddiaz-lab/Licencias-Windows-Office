...
# ID exacto extraído de tu enlace de Google Sheets
SPREADSHEET_ID = "1TxukcYhPDoCKrbqhzbUBKFLauvTRBlwrXq5IH2m0Zs"
    ...
    with st.form("registro_form"):
        ...
        if submit:
            try:
                ...
                # Usamos open_by_key para evitar fallos de ruta de la URL
